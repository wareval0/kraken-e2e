/**
 * Embedded Appium server lifecycle (ADR-0007, mechanism live-verified against
 * appium@3.5.2):
 *
    ...
    `${JSON.stringify(
      {
        ...
        private: true,
        description: 'Generated by Kraken — appium project-mode home (ADR-0007). Do not edit.',
        dependencies,
      },
      null,
      2,
